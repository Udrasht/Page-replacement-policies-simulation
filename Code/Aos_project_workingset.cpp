...
pair<int,int> workingSet_implementation(int no_frame,vector<int>& frames_nos){
...
int main(){
	...
	cout<<"\033[0m";
	 ...
	 ofstream fout("WorkingSetoutput.txt",ios_base::app);
	 ...
	 while(getline(inputFile,str)){
	 	...
	 	//cout<<str<<endl;
	 	getline(inputFile,str);
	 pair<int,int> datacaught=workingSet_implementation(no_frame,frames_nos);
	 	// cout<<str<<endl;
